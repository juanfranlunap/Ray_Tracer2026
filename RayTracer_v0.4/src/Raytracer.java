...
public class Raytracer {
    ...
    private Color shade(Intersection intersection) {
        ...
        // N · L = how much light hits this surface (Lambertian from slide 7)
        ...
        // Diffuse = LC x OC x LI x (N · L)  - slide 9
